  ...
  return (
    <>
      ...
      >
        ...
        <div className="flex-1 p-4 pb-8 space-y-2 overflow-y-auto bg-gradient-to-br from-amber-100 to-orange-100 dark:from-slate-800 dark:to-slate-900">
          {visibleMenuItems.map((item, index) => {
            ...
            return (
              ...
              >
                <Icon className={`w-6 h-6 flex-shrink-0 ${isActive ? 'text-white' : 'text-brand dark:text-blue-300'}`} strokeWidth={2.5} />
        ...
        <div className="relative flex-shrink-0">
          ...
          <div className="absolute top-0 left-0 right-0 h-8 bg-gradient-to-b from-transparent via-amber-100/50 to-amber-100 dark:via-slate-800/50 dark:to-slate-800 pointer-events-none -translate-y-full"></div>

          <div className="p-4 border-t-2 border-brand/20 dark:border-white/10 bg-gradient-to-br from-amber-100 to-orange-100 dark:from-slate-800 dark:to-slate-900 flex items-center justify-center gap-4 shadow-2xl">
            {/* Botón Ver tutorial */}
            {onReplayTour && (
              <IconButton
                label="Ver tutorial"
