...
("EMPIEZA en la página   el número del NOMBRE DEL ARCHIVO de la imagen:", False),
        ...
        ("", False),
        ("                       El año NO se elige en la app: lo pone la fecha de la", False),
        ("                       Misa. No son tres opciones entre las que escoger; es", False),
        ("                       UNA PARA CADA AÑO, y la del año que no toca sería", False),
        ("                       lisa y llanamente otro canto.", False),
        ("", False),
        ("                       Por eso, cuando un canto tiene variante por año, se", False),
        ("                       rellena UNA FILA POR CADA AÑO que el libro traiga: se", False),
        ("                       duplica la fila a mano (copiar y pegar) y se cambia el", False),
        ("                       año y la posición. Los años que el libro no marque", False),
        ("                       usan la fila sin año, si la hay.", False),
        ("", False),
