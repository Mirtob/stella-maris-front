...
// Calendario base (domingos + solemnidades) INLINE — auto-generado desde
// src/data/liturgicalCalendar.generated.json. Va inline (no import) porque en este
// setup de Vercel las funciones deben ser autocontenidas: importar un modulo hermano
// (.ts o .json) crashea la funcion al cargar (FUNCTION_INVOCATION_FAILED).
const BASE_CELEBRATIONS: { date: string; name: string }[] = [
